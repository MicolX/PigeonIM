...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return MessageProtocol.internal_static_AckMessage_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            AckMessage.class, AckMessage.Builder.class);
  }
   ...
   * @return The type.
   */
  @java.lang.Override public AckType getType() {
    @SuppressWarnings("deprecation")
    AckType result = AckType.valueOf(type_);
    return result == null ? AckType.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (type_ != AckType.SENT.getNumber()) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.micolx.testclient.protobuf.AckMessage.newBuilder()
    private Builder() {
  ...
  checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setType(AckType value) {
      if (value == null) {
        throw new NullPointerException();
      }
